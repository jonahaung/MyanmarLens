...
struct TrackedPolyRect {
    ...
    init(observation: VNTextObservation, color: UIColor, style: TrackedPolyRectStyle = .solid) {
...
class TrackingImageView: UIView {
    ...
    var imageAreaRect = UIScreen.main.bounds

    let dashedPhase = CGFloat(2)
    ...
    private func scaleImage(to viewSize: CGSize) -> UIImage? {
        ...
        self.imageAreaRect = self.bounds

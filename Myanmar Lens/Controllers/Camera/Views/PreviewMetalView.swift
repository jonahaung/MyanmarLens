...
class PreviewMetalView: MTKView {
    ...
    let syncQueue = DispatchQueue(label: "Preview View Sync Queue", qos: .userInitiated, attributes: [], autoreleaseFrequency: .workItem)
    ...
    func getCurrentBuffer(_ completion: @escaping (CVImageBuffer) -> Void ) {
        syncQueue.async {

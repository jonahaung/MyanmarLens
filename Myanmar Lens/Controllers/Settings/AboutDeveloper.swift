        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 20) {
               Spacer()
                ...
                Text("Aung Ko Min").font(.system(.title, design: .monospaced)).padding(.vertical, 10)
                Text("“The beauty you see me is a reflection of you”").font(.system(.body, design: .monospaced)) + Text(" ― Rumi").italic()
                Spacer()
                VStack {
                    Button(action: {
